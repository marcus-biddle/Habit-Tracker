...
import { ChartArea, Forward, Goal, Map, Plus, Timer, Waves } from 'lucide-react'
                      ...
                      <div className='flex flex-wrap justify-center items-baseline'>
                        <div className='flex flex-wrap items-start gap-2'>
                          <h1 className='max-w-xs'>
                            {dailySums.length === data.length && <RollingNumber number={dailySums.find(s => s.id === habit.id)?.value} />}
                          </h1>
