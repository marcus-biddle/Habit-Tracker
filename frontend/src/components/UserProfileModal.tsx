...
import { getScoreUnit, type Period, type UserScore } from '../concept/FitnessLeaderboard';
import {
  startOfYear,
  endOfYear,
  startOfISOWeek,
...
interface UserProfileProps {
  ...
  timePeriod: Period;
  setTimePeriod: (period: Period) => void;
  setActiveUserId: (id: string | null) => void;
}

export const UserProfileModal = ({ user, setActiveUserId, activeCategory, timePeriod, setTimePeriod }: UserProfileProps) => {
